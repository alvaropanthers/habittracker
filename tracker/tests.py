...
class UtilTestCases(TestCase):
    def test_break_formatted_date(self):
        self.assertEqual(utils.break_formatted_date('11-20-1995'), [11, 20, 1995])
        self.assertEqual(utils.break_formatted_date('01-01-1995'), [1, 1, 1995])
        self.assertEqual(utils.break_formatted_date('1-1-1995-20'), [])
